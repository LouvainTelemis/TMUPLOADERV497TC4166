...
Test10
    ...
    Wait Until Page Contains    ${MyPatient6PatientID}    timeout=15s
...
Test11
    ...
    Wait Until Element Is Visible    id=patientGivenNameField    timeout=15s
    Wait Until Keyword Succeeds    15s    3s    Textfield Value Should Be    id=gwt-uid-5    ${MyPatient6FirstName}
    Wait Until Element Is Visible    id=patientIdField    timeout=15s
    Wait Until Keyword Succeeds    15s    3s    Textfield Value Should Be    css=#patientIdField > .v-filterselect-input    ${MyPatient6PatientID}
    Wait Until Element Is Visible    id=patientBirthdateField    timeout=15s
    Wait Until Keyword Succeeds    15s    3s    Textfield Value Should Be    css=#patientBirthdateField > .v-filterselect-input    ${MyPatient6BirthdateDD}/${MyPatient6BirthdateMM}/${MyPatient6BirthdateYYYY}

    Wait Until Element Is Visible    id=studyTypeField    timeout=15s
    Wait Until Keyword Succeeds    15s    3s    Textfield Value Should Be    css=#studyTypeField > .v-filterselect-input    ${MyPatient6StudyDescription}
    Wait Until Element Is Visible    id=studyDateField    timeout=10s
    Wait Until Keyword Succeeds    15s    3s    Textfield Value Should Be    css=#studyDateField > .v-filterselect-input    ${MyPatient6StudyDate}
    Wait Until Element Is Visible    id=accesionNumberField    timeout=10s
    Wait Until Keyword Succeeds    15s    3s    Textfield Value Should Be    css=#accesionNumberField > .v-filterselect-input    ${MyPatient6AccessionNumber}
